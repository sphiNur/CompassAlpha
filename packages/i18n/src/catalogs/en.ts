...
export const en = {
  ...
  'settlement.costs.autoTotalTitle': 'Itemized outflows',
  'settlement.costs.autoTotalHint':
    'Add every operating expense and wage row. Their totals are calculated automatically and kept with this daily close.',
  'settlement.expenses.title': 'Operating expense details',
  'settlement.expenses.total': '{money} total',
  'settlement.expenses.add': '+ Add expense',
  'settlement.expenses.empty': 'No operating expenses recorded.',
  'settlement.expenses.itemNumber': 'Expense {n}',
  'settlement.expenses.category': 'Category',
  'settlement.expenses.amount': 'Amount',
  ...
  'settlement.expenseCategory.maintenance': 'Maintenance',
  'settlement.expenseCategory.rent': 'Rent',
  'settlement.expenseCategory.other': 'Other',
  'settlement.wages.title': 'Wage details',
  'settlement.wages.totals': 'Paid {paid} · Unpaid {unpaid}',
  'settlement.wages.add': '+ Add wage',
  ...
  'settlement.wages.amount': 'Amount',
  'settlement.wages.reason': 'Shift, pay period, or reason',
  'settlement.wages.remove': 'Remove',
  'settlement.confirm.discard': 'Discard unsaved daily-close changes?',
  'settlement.confirm.removeDetail':
    'Remove this detail row? The saved close will change only after you save the correction.',
