...
export const ru = {
  ...
  'common.errorUnknown': 'Неизвестная ошибка',
  'qty.decrement': 'Уменьшить',
  'qty.increment': 'Увеличить',
  'qty.pickAria': 'Количество {value} — нажмите, чтобы выбрать',
  'qty.setTitle': 'Указать количество',
  'qty.unitIs': 'Единица: {unit}',
  'qty.custom': 'Своё значение',
  'qty.setValue': 'Указать {value}',
  'photo.label': 'Фото чека',
  'photo.remove': 'Удалить фото',
  'photo.hint': 'Нажмите, чтобы сфотографировать',
  'photo.uploading': 'Загрузка…',
  'common.create': 'Создать',
  'common.edit': 'Изменить',
  'common.delete': 'Удалить',
  'catalog.category.new': 'Новая категория',
  'catalog.category.edit': 'Изменить категорию',
  'catalog.category.emptyTitle': 'Нет категорий',
  'catalog.category.emptyBody': 'Группируют товары на странице заказа.',
  'catalog.sku.new': 'Новый товар',
  'catalog.sku.edit': 'Изменить товар',
  'catalog.sku.confirmArchive': 'Архивировать товар «{name}»?',
  'catalog.supplier.new': 'Новый поставщик',
  'catalog.supplier.edit': 'Изменить поставщика',
  'catalog.supplier.emptyTitle': 'Нет поставщиков',
  'catalog.supplier.emptyBody': 'Учёт того, у кого вы покупаете на рынке.',
  'catalog.supplier.confirmArchive': 'Архивировать поставщика «{name}»?',
  'admin.store.new': 'Новый магазин',
  'admin.store.emptyTitle': 'Нет магазинов',
  'admin.store.emptyBody': 'Создайте магазин кнопкой выше, чтобы добавить команду.',
  'admin.store.confirmArchive': 'Архивировать «{name}»?',
  'admin.store.tabTeam': 'Команда',
  'admin.store.tabInventory': 'Склад',
  'admin.store.tabSales': 'Продажи',
  'admin.store.tabSettings': 'Настройки',
  'nav.primaryAriaLabel': 'Основные разделы',
  'admin.store.createHint':
    'Роль по умолчанию и остальные настройки можно задать после создания магазина — откройте его из списка и перейдите на вкладку «Настройки».',
  'admin.store.readOnlyBody':
    'Вы не администрируете этот магазин. Настройки видны, но изменить их из вашей учётной записи нельзя.',
  'admin.clone.title': 'Клонировать роли в магазин',
  'admin.clone.target': 'Цель: {store}',
  'admin.clone.action': 'Клонировать',
  'admin.clone.noSourceTitle': 'Нет подходящего источника',
  'admin.clone.noSourceBody':
    'Нужно администрировать хотя бы один ДРУГОЙ магазин, чтобы клонировать из него. Попросите администратора выше по рангу добавить вас.',
  'admin.clone.alsoMembers': 'Также назначить сотрудников источника',
  'admin.clone.alsoMembersHint':
    'Если включено, каждый сотрудник с привязкой к магазину-источнику получит её и для целевого — они будут видеть и работать в обоих. По умолчанию выключено: клонируется только структура ролей.',
  'admin.clone.whatTitle': 'Что произойдёт',
  'admin.clone.whatBody':
    'Для каждой привязки роли в магазине-источнике создать такую же в {store} (дубликаты пропускаются). Роли, которые вы не превосходите по рангу в {store}, пропускаются — они считаются отдельно.',
  'ops.activity.emptyTitle': 'Пока нет событий',
  'ops.activity.emptyBody': 'События появятся, когда заказы или закупки начнут двигаться.',
  'ops.history.emptyTitle': 'Пока ничего не отправлено',
  'ops.history.emptyBody': 'Заказы появятся здесь, когда сотрудники нажмут «Отправить».',
  'ops.history.contributorBreakdown': 'Разбивка по участникам',
  'ops.purge.tabOrders': 'Заказы',
  'ops.purge.tabRuns': 'Закупки',
  'ops.purge.noSessionsTitle': 'Нет заказов',
  'ops.purge.noSessionsBody': '{date} — ничего не отправлялось.',
  'ops.purge.noRunsTitle': 'Нет закупок',
  'ops.purge.noRunsBody': '{date} — закупок не было.',
  'ops.purge.deleteRunTitle': 'Удалить закупку',
  'ops.purge.cascadeTitle': 'Вместе с ней удалятся привязанные заказы',
  'ops.purge.cascadeBody':
    'Удаление этой закупки удалит и привязанные к ней заказы ({n}). Сервер откажет, если хотя бы один принадлежит реальному пользователю — тогда используйте удаление по одному заказу.',
  'ops.audit.allScopes': 'Все области',
  'ops.audit.inputs': 'входные данные',
  'ops.price.howTitle': 'Как это читать',
  'ops.price.howBody':
    'Наблюдения цен за последние 30 дней по всей организации. Последний столбец — изменение относительно среднего за 30 дней: зелёный дешевле, красный — скачок. Для бюджета на завтра берите среднее за 7 дней; за 30 дней сглаживает недельные колебания.',
  'ops.price.emptyTitle': 'Пока нет данных о ценах',
  'ops.price.emptyBody': 'Как только закупщик внесёт первую закупку, цены появятся здесь.',
  'ops.maint.superOnlyTitle': 'Только для супер-администратора',
  'ops.maint.superOnlyBody':
    'Действия обслуживания могут навсегда удалить данные. Этот раздел доступен только участникам с ролью super_admin.',
  'ops.maint.targetedTitle': 'Удалить конкретный тестовый заказ или закупку',
  'ops.maint.targetedBody':
    'Используйте, когда тестовые и реальные данные попали на один день. Откройте список, выберите тестовый заказ или закупку, посмотрите, что удалится каскадом, затем подтвердите. Заказы реальных пользователей не затрагиваются.',
  'ops.maint.resetToday': 'Сбросить сегодня',
  'ops.maint.resetDateTitle': 'Сбросить конкретную дату',
  'ops.maint.resetDateBody': 'Та же область, другой день. Выберите дату ниже.',
  'ops.maint.preview': 'Предпросмотр',
  'ops.maint.wipeTitle': 'Очистить всё рабочее пространство',
  'ops.maint.wipeBody':
    'Кнопка ниже удалит все события, закупки, заказы, уведомления и записи outbox, которые когда-либо создавало это рабочее пространство — независимо от даты. Только для полного старта с нуля.',
  'ops.maint.purgeAllTitle': 'Удалить ВСЕ тестовые данные',
  'ops.maint.purgeAllBody':
    'Шаг 1 показывает количество строк. Шаг 2 удаляет после того, как вы введёте идентификатор рабочего пространства.',
  'ops.maint.previewEverything': 'Предпросмотр всего',
  ...
  'people.orgLevelEmptyBody':
    'Здесь появляются администраторы и супер-администраторы, не привязанные к конкретному магазину.',
  'people.permsHowTitle': 'Как работают права',
  'people.permsHowBody':
    'Роль — это набор ключей прав. Выше ранг — больше полномочий. Выдать роль участнику можно только если её ранг строго ниже вашего ({rank}). Встроенные роли нельзя удалить, но имя, описание и набор прав редактируются.',
  'people.rolesHeading': 'Роли',
  'people.rolesEmptyTitle': 'Нет ролей',
  'people.rolesEmptyBody': 'Запустите db:seed, чтобы получить встроенные роли.',
  'people.newRoleTitle': 'Новая роль',
  'people.newRoleHint': 'Пользовательские роли могут иметь ранг от 1 до {max}.',
  'people.rolePlaceholderName': 'Старший смены',
  'people.rolePlaceholderDesc': 'Необязательно',
  'people.rankField': 'Ранг (1–{max})',
  'people.deleteRole': 'Удалить роль',
  'people.confirmDeleteRole': 'Удалить роль «{name}»?',
  'people.noRole': 'Нет роли',
  'people.orgLevelLabel': 'Уровень организации',
  'people.storeGone': '— магазина больше нет —',
  'people.inviteTitle': 'Пригласить участника',
  'people.inviteHint': 'Выберите способ',
  'people.inviteViaTelegram': 'Поделиться через Telegram',
  'people.inviteCopyLink': 'Скопировать ссылку-приглашение',
  'people.inviteCopyLinkHint': 'Можно вставить где угодно вне Telegram.',
  'people.inviteOr': 'или',
  'people.inviteByTgId': 'Добавить по Telegram ID',
  'people.inviteByTgIdHint': 'Введите числовой TG ID напрямую, если вы его уже знаете.',
  'people.memberFallback': 'Участник',
  'people.editMemberHint': 'Изменить имя и назначить магазины',
  'people.transferTooltip': 'Перевести участника в другой магазин',
  'people.transferTitle': 'Перевод между магазинами',
  'people.transferMoving': 'Перевести {name}',
  'people.transferAction': 'Перевести',
  'people.transferFrom': 'Откуда',
  'people.transferTo': 'Куда',
  'people.transferNoDestTitle': 'Нет подходящих магазинов',
  'people.transferNoDestBody':
    'Вы не администрируете другие магазины. Попросите администратора выше по рангу сначала добавить вас в магазин назначения.',
  'people.mirrorRoles': 'Продублировать привязки ролей',
  'people.mirrorRolesHint':
    'Если включено (по умолчанию), каждая роль этого участника в {store} дублируется в магазине назначения, роль сохраняется. Выключите, чтобы не давать роль на новом месте — полезно, когда перевод означает повышение или понижение.',
  'people.transferWhatTitle': 'Что произойдёт',
  'people.transferWhatIntro': 'Атомарно, в одной транзакции:',
  'people.transferWhatAdded': '{name} добавляется в магазин назначения',
  ...
  'people.overridesHowTitle': 'Как это работает',
  'people.overridesHowGlobal':
    'Каждая строка показывает, что даёт роль (серым), и позволяет переопределить для участника: allow — включить принудительно, deny — выключить. При конфликте deny всегда важнее.',
  'people.overridesHowStore':
    'Переопределения на этой вкладке действуют только в {store}. Базовый набор от роли одинаков во всех магазинах; allow/deny по магазину позволяет точно настроить, что участник может делать именно здесь.',
  'people.toastRoleGranted': 'Роль выдана',
  'people.toastRoleAlready': 'Роль уже назначена',
  'people.grantRoleTitle': 'Выдать роль',
  'people.grantRoleTo': 'участнику {name}',
  'people.grantGlobally': 'Глобально',
  'people.grantGloballyLocked': 'Глобально (только админ организации)',
  'people.noGrantStoresTitle': 'Нет магазинов для выдачи',
  ...
  'people.noStoresInOrg': 'В этой организации нет магазинов. Создайте его на вкладке «Каталог».',
  'people.storeScopeHint':
    'Сотрудники могут оформлять заказы и подтверждать поставки только для магазинов, к которым привязаны. Администраторы видят все магазины.',
  'people.globalGrantLockedHint':
    'Глобальные роли уровня организации могут выдавать только администраторы организации. Роли по магазинам вы по-прежнему можете назначать там, где администрируете.',
  'people.pickScopeFirst': 'Сначала выберите область выше, чтобы увидеть доступные роли.',
  'ops.maint.resetTodayTitle': 'Сбросить весь поток за сегодня',
  'ops.maint.resetTodayBody':
    'Удаляет все заказы, закупки, поставки, уведомления и записи истории цен с датой {date} — независимо от того, кто их создал. Каталог и участники не затрагиваются. Используйте, только если уверены, что за сегодня нет данных реальных пользователей.',
  'ops.maint.nothingToPurge': 'Удалять нечего — рабочее пространство уже чистое.',
  'admin.store.defaultRoleHint':
    'Если задано, новые участники, приглашённые в этот магазин без явного выбора роли, получают эту роль автоматически.',
  'people.toastRemovedFromStore': 'Удалён из магазина',
  'people.toastRolesRevoked':
    '{n, plural, one {отозвана # роль} few {отозвано # роли} other {отозвано # ролей}}',
  'people.toastOverridesDropped':
    '{n, plural, one {снято # переопределение} few {снято # переопределения} other {снято # переопределений}}',
  'people.toastTransferred': 'Переведён',
  'people.toastRolesMirrored':
    '{n, plural, one {продублирована # роль} few {продублировано # роли} other {продублировано # ролей}}',
  'people.toastFromSideRevoked':
    '{n, plural, one {отозвана # роль на стороне источника} other {отозвано # ролей на стороне источника}}',
  ...
  'ops.history.contributorCount':
    '{n, plural, one {# участник} few {# участника} other {# участников}}',
  'admin.clone.toastCloned':
    'Клонировано {n, plural, one {# привязка роли} few {# привязки роли} other {# привязок ролей}}',
  'admin.clone.toastAlreadyExisted': '{n} уже существовало',
  'admin.clone.toastSkippedRank': '{n} пропущено (ранг слишком высок)',
  'admin.clone.toastAssigned':
    'назначено {n, plural, one {# участник} few {# участника} other {# участников}}',
  'people.newRoleButton': 'Новая роль',
  'catalog.category.newButton': 'Новая категория',
  'catalog.supplier.newButton': 'Новый поставщик',
  'people.builtInLocked': 'Ранг {rank} (встроенная, заблокирована)',
  'people.builtInRankBody':
    'Ранг встроенной роли изменить нельзя — он задаёт основу лестницы прав. Для пользовательских ролей ранг выбираете вы.',
  'people.rankOutranksYou': 'ваш ранг ≤ этого',
  'people.roleFallback': 'Роль',
  'people.rankLine': 'ранг {rank}',
  'people.roleMetaLine': 'ранг {rank} · {perms}',
  'people.roleNameWithRank': '{name} (ранг {rank})',
  'admin.store.noDefaultRole': '— без роли по умолчанию (выбирается при каждом приглашении) —',
  'run.status.planned': 'Запланирована',
  'run.status.purchasing': 'Закупка',
  'run.status.delivering': 'Доставка',
  'run.status.finished': 'Завершена',
  'run.status.cancelled': 'Отменена',
  'run.status.amending': 'Исправление',
  'time.justNow': 'только что',
  'time.minutesAgo': '{n} мин назад',
  'time.hoursAgo': '{n} ч назад',
  'time.daysAgo': '{n} дн назад',
  'ops.history.submittedAgo': 'отправлено {when}',
  'ops.history.byWhom': 'от {name}',
  'ops.history.rejectionReason': 'Причина отказа: {reason}',
  ...
  'storeSwitcher.pickPrompt.body':
    'Странице нужен конкретный магазин. Нажмите на чип магазина сверху, чтобы выбрать.',
  'auth.signIn': 'Войти',
  'auth.signOut': 'Выйти',
  ...
  'order.batches.viewing': 'открыта',
  'order.receipt.submittedItems': 'Что вы отправили',
  ...
  'run.banner.planLockWarning':
    'Старт закрепит {n} одобренных заказов за этой закупкой — вернуть их на согласование будет нельзя. Отдельный заказ всё ещё можно исключить.',
  ...
  'run.label.sessionsCount': '{n, plural, one {# заказ} few {{n} заказа} other {{n} заказов}}',
  'run.label.itemsProgress': '{bought} куп. · {na} нет · {pending} ост.',
  'run.filter.all': 'Все {n}',
  'run.filter.pending': 'Осталось {n}',
  'run.filter.unavailable': 'Нет {n}',
  'run.filter.ariaLabel': 'Фильтр товаров',
  ...
  'run.previewShare.sendList': 'Отправить',
  'run.previewShare.sendAll': 'Отправить всё',
  'run.previewShare.opened': 'Открыт выбор контакта',
  'run.previewShare.openedWithCopy': 'Открыт выбор контакта; список также скопирован',
  'run.preview.groupTotal': 'Итого',
  'run.preview.priceUnknown': 'Уточнить цену',
  ...
  'run.price.fillIn': 'Указать цену',
  'run.offline.needNetworkToStart': 'Для начала закупки нужна сеть',
  'run.toast.runAlreadyOpen': 'Закупка уже идёт — открыта она',
  'run.price.daysAgo': '{n} дн. назад',
  'run.finish.carriedOver': '{n} позиций по прежней цене',
  'run.finish.carriedOverStale': 'из них {n} старше {days} дней',
  ...
  'run.view.ariaLabel': 'Группировка списка закупки',
  ...
  'run.action.remainingItems': 'Осталось обработать: {n}',
  ...
  'run.label.staleRun': '{days} дн.',
  'run.label.priceUnitAria': 'Единица цены — нажмите, чтобы переключить UZS / тысячи',
  ...
  'run.history.lastRun': 'Последняя закупка {date}',
  'run.history.monthSoFar': '{month} · пока {n}',
  'run.history.totalLine': 'Итого {total} UZS',
  'run.history.allStores': 'Все магазины',
  ...
  'run.errors.cannotAmend': 'Только супер-администратор может править завершённую закупку',
  'run.errors.notReopenable': 'Только завершённую закупку можно открыть для правки',
  'run.errors.invalidRunDate': 'Введите корректную дату (ГГГГ-ММ-ДД)',
  'run.errors.runDateUnchanged': 'Это уже дата этой закупки',
  'run.date.label': 'Дата закупки',
  'run.date.change': 'Изменить дату закупки',
  'run.date.hint': 'День, на который списывается расход. История группируется по нему.',
  'run.date.changed': 'Дата закупки обновлена',
  'run.errors.notRefinalizable': 'Эта закупка не в режиме правки',
  'run.errors.reopenReasonRequired': 'Укажите причину повторного открытия',
  ...
  'run.amend.reasonPlaceholder': 'Причина правки (обязательно)',
  'run.amend.reopenButton': 'Открыть для правки',
  ...
  'confirm.progress': 'Проверено {done}/{total}',
  'confirm.markAllOk': 'Всё в порядке',
  'confirm.confirmStoreBlocked': 'Осталось проверить: {n}',
  ...
  'confirm.toast.allMarkedOk': 'Позиций отмечено: {n}',
  ...
  'confirm.status.ariaLabel': 'Статус приёмки позиции',
  ...
  'settlement.costs.autoTotalTitle': 'Постатейные расходы',
  'settlement.costs.autoTotalHint':
    'Добавьте каждую операционную расходную строку и выплату зарплаты. Итоги рассчитываются автоматически и сохраняются с закрытием дня.',
  'settlement.expenses.title': 'Детали операционных расходов',
  'settlement.expenses.total': 'Итого {money}',
  'settlement.expenses.add': '+ Добавить расход',
  'settlement.expenses.empty': 'Операционные расходы ещё не записаны.',
  'settlement.expenses.itemNumber': 'Расход {n}',
  'settlement.expenses.category': 'Категория',
  'settlement.expenses.amount': 'Сумма',
  ...
  'settlement.expenseCategory.maintenance': 'Ремонт и обслуживание',
  'settlement.expenseCategory.rent': 'Аренда',
  'settlement.expenseCategory.other': 'Другое',
  'settlement.wages.title': 'Детали зарплаты',
  'settlement.wages.totals': 'Выплачено {paid} · Не выплачено {unpaid}',
  'settlement.wages.add': '+ Добавить зарплату',
  ...
  'settlement.wages.amount': 'Сумма',
  'settlement.wages.reason': 'Смена, период или причина',
  'settlement.wages.remove': 'Удалить',
  'settlement.confirm.discard': 'Отменить несохранённые изменения закрытия дня?',
  'settlement.confirm.removeDetail':
    'Удалить эту строку? Сохранённое закрытие изменится только после сохранения исправления.',
